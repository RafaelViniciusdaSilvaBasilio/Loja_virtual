...
-- Started on 2026-02-25 13:11:29
...
--
-- TOC entry 254 (class 1255 OID 17229)
...
--
-- TOC entry 255 (class 1255 OID 17236)
...
--
-- TOC entry 247 (class 1259 OID 16996)
...
--
-- TOC entry 250 (class 1259 OID 17053)
...
--
-- TOC entry 252 (class 1259 OID 17089)
...
--
-- TOC entry 231 (class 1259 OID 16727)
...
--
-- TOC entry 251 (class 1259 OID 17072)
...
--
-- TOC entry 253 (class 1259 OID 17116)
...
CREATE TABLE public.vd_cp_loja_virt (
    ...
    dia_venda timestamp(6) without time zone NOT NULL,
    valor_desconto numeric(38,2),
...
--
-- TOC entry 3517 (class 0 OID 16729)
-- Dependencies: 233
...
--
-- TOC entry 3518 (class 0 OID 16734)
-- Dependencies: 234
-- Data for Name: avaliacao_produto; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.avaliacao_produto (nota, id, pessoa_id, produto_id, descricao) FROM stdin;
10	1	1	1	teste avaliação produto trigger
\.


--
-- TOC entry 3519 (class 0 OID 16739)
-- Dependencies: 235
...
COPY public.cup_desc (valor_porcent_desc, valor_real_desc, id, cod_desc, data_validade_cupom) FROM stdin;
\.


--
-- TOC entry 3531 (class 0 OID 16996)
-- Dependencies: 247
...
--
-- TOC entry 3523 (class 0 OID 16773)
-- Dependencies: 239
-- Data for Name: form_pagamento; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.form_pagamento (id, descricao) FROM stdin;
\.


--
-- TOC entry 3532 (class 0 OID 17019)
-- Dependencies: 248
...
--
-- TOC entry 3524 (class 0 OID 16785)
-- Dependencies: 240
...
--
-- TOC entry 3525 (class 0 OID 16790)
-- Dependencies: 241
...
--
-- TOC entry 3533 (class 0 OID 17031)
-- Dependencies: 249
...
--
-- TOC entry 3534 (class 0 OID 17053)
-- Dependencies: 250
...
--
-- TOC entry 3526 (class 0 OID 16811)
-- Dependencies: 242
...
--
-- TOC entry 3527 (class 0 OID 16823)
-- Dependencies: 243
-- Data for Name: pessoa_fisica; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.pessoa_fisica (data_nascimento, id, cpf, email, nome, telefone) FROM stdin;
1987-10-10	1	89578699987	ases@gmail.c	Elon	87859492021
\.


--
-- TOC entry 3528 (class 0 OID 16828)
-- Dependencies: 244
-- Data for Name: pessoa_juridica; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.pessoa_juridica (id, categoria, cnpj, insc_estadual, insc_municipal, nome_fantasia, razao_social, email, nome, telefone) FROM stdin;
\.


--
-- TOC entry 3536 (class 0 OID 17089)
-- Dependencies: 252
-- Data for Name: produto; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.produto (id, qtd_alerta_estoque, qtd_estoque, alerta_qtde_estoque, altura, ativo, descricao, largura, link_youtube, nome, peso, profundidade, qtde_clique, tipo_unidade, valor_venda) FROM stdin;
1	1	1	t	10	t	produto teste	50.2	sdsdsdsds	nome produto teste	50	80.8	50	UN	50.00
\.


--
-- TOC entry 3529 (class 0 OID 16842)
-- Dependencies: 245
-- Data for Name: status_rastreio; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.status_rastreio (id, venda_compra_loja_virtual_id, centro_distribuicao, cidade, estados, status) FROM stdin;
\.


--
-- TOC entry 3535 (class 0 OID 17072)
-- Dependencies: 251
...
--
-- TOC entry 3530 (class 0 OID 16856)
-- Dependencies: 246
...
--
-- TOC entry 3537 (class 0 OID 17116)
-- Dependencies: 253
-- Data for Name: vd_cp_loja_virt; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.vd_cp_loja_virt (id, data_entrega, dia_entrega, dia_venda, valor_desconto, valor_frete, valor_total, cupom_desc_id, endereco_cobranca_id, endereco_entrega_id, forma_pagamento_id, nota_fiscal_venda_id, pessoa_id) FROM stdin;
\.
...
--
-- TOC entry 3279 (class 2606 OID 16738)
...
--
-- TOC entry 3281 (class 2606 OID 16743)
...
--
-- TOC entry 3283 (class 2606 OID 16751)
...
--
-- TOC entry 3285 (class 2606 OID 16759)
...
--
-- TOC entry 3309 (class 2606 OID 17025)
...
--
-- TOC entry 3291 (class 2606 OID 16789)
...
--
-- TOC entry 3311 (class 2606 OID 17037)
...
--
-- TOC entry 3313 (class 2606 OID 17059)
...
--
-- TOC entry 3295 (class 2606 OID 16815)
...
--
-- TOC entry 3297 (class 2606 OID 16827)
...
--
-- TOC entry 3299 (class 2606 OID 16834)
...
--
-- TOC entry 3319 (class 2606 OID 17095)
...
--
-- TOC entry 3301 (class 2606 OID 16848)
...
--
-- TOC entry 3321 (class 2606 OID 17122)
...
--
-- TOC entry 3315 (class 2606 OID 17061)
...
--
-- TOC entry 3303 (class 2606 OID 16862)
...
--
-- TOC entry 3305 (class 2606 OID 16860)
...
--
-- TOC entry 3317 (class 2606 OID 17078)
...
--
-- TOC entry 3323 (class 2606 OID 17120)
...
--
-- TOC entry 3340 (class 2620 OID 17230)
...
--
-- TOC entry 3341 (class 2620 OID 17231)
...
--
-- TOC entry 3346 (class 2620 OID 17239)
-- Name: conta_receber validarchavepessoa; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validarchavepessoa BEFORE UPDATE ON public.conta_receber FOR EACH ROW EXECUTE FUNCTION public.validachavepessoa();


--
-- TOC entry 3348 (class 2620 OID 17241)
-- Name: endereco validarchavepessoa; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validarchavepessoa BEFORE UPDATE ON public.endereco FOR EACH ROW EXECUTE FUNCTION public.validachavepessoa();


--
-- TOC entry 3350 (class 2620 OID 17243)
-- Name: nota_fiscal_compra validarchavepessoa; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validarchavepessoa BEFORE UPDATE ON public.nota_fiscal_compra FOR EACH ROW EXECUTE FUNCTION public.validachavepessoa();


--
-- TOC entry 3352 (class 2620 OID 17245)
-- Name: usuario validarchavepessoa; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validarchavepessoa BEFORE UPDATE ON public.usuario FOR EACH ROW EXECUTE FUNCTION public.validachavepessoa();


--
-- TOC entry 3354 (class 2620 OID 17247)
-- Name: vd_cp_loja_virt validarchavepessoa; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validarchavepessoa BEFORE UPDATE ON public.vd_cp_loja_virt FOR EACH ROW EXECUTE FUNCTION public.validachavepessoa();


--
-- TOC entry 3347 (class 2620 OID 17240)
-- Name: conta_receber validarchavepessoa2; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validarchavepessoa2 BEFORE INSERT ON public.conta_receber FOR EACH ROW EXECUTE FUNCTION public.validachavepessoa();


--
-- TOC entry 3349 (class 2620 OID 17242)
-- Name: endereco validarchavepessoa2; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validarchavepessoa2 BEFORE INSERT ON public.endereco FOR EACH ROW EXECUTE FUNCTION public.validachavepessoa();


--
-- TOC entry 3351 (class 2620 OID 17244)
-- Name: nota_fiscal_compra validarchavepessoa2; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validarchavepessoa2 BEFORE INSERT ON public.nota_fiscal_compra FOR EACH ROW EXECUTE FUNCTION public.validachavepessoa();


--
-- TOC entry 3353 (class 2620 OID 17246)
-- Name: usuario validarchavepessoa2; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validarchavepessoa2 BEFORE INSERT ON public.usuario FOR EACH ROW EXECUTE FUNCTION public.validachavepessoa();


--
-- TOC entry 3355 (class 2620 OID 17248)
-- Name: vd_cp_loja_virt validarchavepessoa2; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validarchavepessoa2 BEFORE INSERT ON public.vd_cp_loja_virt FOR EACH ROW EXECUTE FUNCTION public.validachavepessoa();


--
-- TOC entry 3342 (class 2620 OID 17234)
-- Name: conta_pagar validarchavepessoacontapagar; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validarchavepessoacontapagar BEFORE UPDATE ON public.conta_pagar FOR EACH ROW EXECUTE FUNCTION public.validachavepessoa();


--
-- TOC entry 3343 (class 2620 OID 17235)
-- Name: conta_pagar validarchavepessoacontapagar2; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validarchavepessoacontapagar2 BEFORE INSERT ON public.conta_pagar FOR EACH ROW EXECUTE FUNCTION public.validachavepessoa();


--
-- TOC entry 3344 (class 2620 OID 17237)
-- Name: conta_pagar validarchavepessoacontapagarpessoa_forn_id; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validarchavepessoacontapagarpessoa_forn_id BEFORE UPDATE ON public.conta_pagar FOR EACH ROW EXECUTE FUNCTION public.validachavepessoa2();


--
-- TOC entry 3345 (class 2620 OID 17238)
-- Name: conta_pagar validarchavepessoacontapagarpessoa_forn_id2; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validarchavepessoacontapagarpessoa_forn_id2 BEFORE INSERT ON public.conta_pagar FOR EACH ROW EXECUTE FUNCTION public.validachavepessoa2();


--
-- TOC entry 3330 (class 2606 OID 16955)
...
--
-- TOC entry 3333 (class 2606 OID 17038)
...
--
-- TOC entry 3335 (class 2606 OID 17138)
...
--
-- TOC entry 3336 (class 2606 OID 17143)
...
--
-- TOC entry 3338 (class 2606 OID 17153)
...
--
-- TOC entry 3327 (class 2606 OID 17048)
...
--
-- TOC entry 3339 (class 2606 OID 17158)
...
--
-- TOC entry 3324 (class 2606 OID 17096)
...
--
-- TOC entry 3332 (class 2606 OID 17101)
...
--
-- TOC entry 3325 (class 2606 OID 17106)
...
--
-- TOC entry 3328 (class 2606 OID 17111)
...
--
-- TOC entry 3331 (class 2606 OID 17084)
...
--
-- TOC entry 3326 (class 2606 OID 17123)
...
-- Completed on 2026-02-25 13:11:29
